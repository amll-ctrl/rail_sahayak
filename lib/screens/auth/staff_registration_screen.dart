...
class _StaffRegistrationScreenState extends State<StaffRegistrationScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      _show(
        'Staff application submitted. An administrator must approve it before Staff Login is enabled.',
      );
      if (mounted) Navigator.of(context).pop();
    } on FirebaseAuthException catch (e) {
      if (e.code == 'email-already-in-use') {
        _show(
          'This email already has a Firebase account. Use Staff Login or reset its password.',
          isError: true,
        );
      ...
      _show(
        'Could not submit the staff application (${e.code}). Please try again.',
        isError: true,
      );
    } catch (e) {
      _show(
        'Could not submit the staff application: $e',
        isError: true,
      );
    } finally {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        'Create your RailSahayak staff account. The administrator will review and approve your request before Staff Login is enabled.',
                        textAlign: TextAlign.center,
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'RailSahayak Company Email',
                      ...
                      TextFormField(
                        ...
                        validator: (v) => RegExp(r'^\d{10}$').hasMatch(
                      ...
                      const SizedBox(height: 12),
                      const Text(
                        'Your password is used only to create your Firebase Authentication account. It is never stored in Firestore. The account cannot access Staff Dashboard until an administrator approves the application.',
                        textAlign: TextAlign.center,
