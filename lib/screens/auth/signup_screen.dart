...
class _SignupScreenState extends State<SignupScreen> {
    ...
    try {
      ...
      if (!success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Could not create your account. The email or username may already be in use. Please try again.',
            ),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text(
            'Passenger account created successfully! You can now log in.',
          ),
  ...
  Widget build(BuildContext context) {
    final isLoading =
        context.watch<RequestProvider>().isLoading || _isCompleting;
