...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<List<Map<String, dynamic>>> _loadStaffRequests() async {
    final snapshot = await FirebaseFirestore.instance
        .collection('users')
        .where('status', isEqualTo: 'pending_staff')
        .where('staffApplication', isEqualTo: true)
        .get();
  ...
  Future<void> _approveRequest(Map<String, dynamic> request) async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Could not approve staff application: $e'),
          ...
          children: [
            ...
            FutureBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.hasError) {
                  return Card(
                    child: ListTile(
                      title: const Text('Could not load staff applications'),
                ...
                if (requests.isEmpty) {
                  return const Card(
                    ...
                    child: ListTile(
                      ...
                      title: Text('No pending staff applications'),
                    ),
                  );
                }
            ...
            const Card(
              ...
              child: Padding(
                ...
                child: Text(
                  'Staff approval is stored in the user profile. Passwords are never stored in Firestore. Staff must authenticate with their approved company email.',
                ),
              ),
            ),
          ],
